...
for snr=0:5:40
    ...
    %for N_S=4:4:16
     %   iiii=iiii+1;
        ...
        mse_J_ICCD(jjjj)=mean(mse_JOINT_ICCD);
        mse_ICCD(jjjj)=mean(mse_IND_ICCD);
        mse_ST(jjjj)=mean(mse_STFT);
        mse_TFF(jjjj)=mean(mse_TF);
        mse_G(jjjj)=mean(mse_GD);
...
figure;
plot(0:5:40,mse_J_ICCD,'k','linewidth',3);
hold on;
plot(0:5:40,mse_ICCD,'r','linewidth',3);
hold on;
plot(0:5:40,mse_ST,'b','linewidth',3);
hold on;
plot(0:5:40,mse_TFF,'g','linewidth',3);
hold on;
plot(0:5:40,mse_G,'m','linewidth',3);
