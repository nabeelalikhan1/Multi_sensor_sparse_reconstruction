    ...
    for k1=1:NS
        ...
        for kkkkk=0:3
            ...
            elseif kkkkk==1 %the new algorithm
                ...
                [ext_sig,findex] = FAST_IF_Recover(Sig,length(Sig)/(2)-1, num, 2,100,0,0,NA);
...
figure;
plot(8:4:20,mse_IAA(1,:),'k','linewidth',3);
hold on;
plot(8:4:20,mse_ST(1,:),'r','linewidth',3);
hold on;
plot(8:4:20,mse_TF(1,:),'b','linewidth',3);
hold on;
plot(8:4:20,mse_GDD(1,:),'g','linewidth',3);
...
plot(8:4:20,mse_IAA(2,:),'k','linewidth',3);
hold on;
plot(8:4:20,mse_ST(2,:),'r','linewidth',3);
hold on;
plot(8:4:20,mse_TF(2,:),'b','linewidth',3);
hold on;
plot(8:4:20,mse_GDD(2,:),'g','linewidth',3);
...
plot(8:4:20,mse_IAA(3,:),'k','linewidth',3);
hold on;
plot(8:4:20,mse_ST(3,:),'r','linewidth',3);
hold on;
plot(8:4:20,mse_TF(3,:),'b','linewidth',3);
hold on;
plot(8:4:20,mse_GDD(3,:),'g','linewidth',3);
...
plot(8:4:20,mse_IAA(4,:),'k','linewidth',3);
hold on;
plot(8:4:20,mse_ST(4,:),'r','linewidth',3);
hold on;
plot(8:4:20,mse_TF(4,:),'b','linewidth',3);
hold on;
plot(8:4:20,mse_GDD(4,:),'g','linewidth',3);
