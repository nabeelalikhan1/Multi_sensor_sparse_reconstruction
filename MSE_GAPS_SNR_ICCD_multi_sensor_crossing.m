...
s2=hanning(128)'.*exp(2*pi*1i*(0.5*n-0.4*n.^3/(128*128*3)));
perc=0.4;
...
hold on;
plot(4:4:16,mse_G(1,:),'m','linewidth',3);
...
plot(4:4:16,mse_J_ICCD(2,:),'k','linewidth',3);
hold on;
plot(4:4:16,mse_ICCD(2,:),'r','linewidth',3);
hold on;
plot(4:4:16,mse_ST(2,:),'b','linewidth',3);
hold on;
plot(4:4:16,mse_TFF(2,:),'g','linewidth',3);
hold on;
plot(4:4:16,mse_G(2,:),'m','linewidth',3);
...
plot(4:4:16,mse_J_ICCD(3,:),'k','linewidth',3);
hold on;
plot(4:4:16,mse_ICCD(3,:),'r','linewidth',3);
hold on;
plot(4:4:16,mse_ST(3,:),'b','linewidth',3);
hold on;
plot(4:4:16,mse_TFF(3,:),'g','linewidth',3);
hold on;
plot(4:4:16,mse_G(3,:),'m','linewidth',3);
...
plot(4:4:16,mse_J_ICCD(4,:),'k','linewidth',3);
hold on;
plot(4:4:16,mse_ICCD(4,:),'r','linewidth',3);
hold on;
plot(4:4:16,mse_ST(4,:),'b','linewidth',3);
hold on;
plot(4:4:16,mse_TFF(4,:),'g','linewidth',3);
hold on;
plot(4:4:16,mse_G(4,:),'m','linewidth',3);
...
plot(4:4:16,mse_J_ICCD(5,:),'k','linewidth',3);
hold on;
plot(4:4:16,mse_ICCD(5,:),'r','linewidth',3);
hold on;
plot(4:4:16,mse_ST(5,:),'b','linewidth',3);
hold on;
plot(4:4:16,mse_TFF(5,:),'g','linewidth',3);
hold on;
plot(4:4:16,mse_G(5,:),'m','linewidth',3);
